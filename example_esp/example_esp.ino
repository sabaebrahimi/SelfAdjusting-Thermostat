...
constexpr char WIFI_SSID[] = "SabaNet";
constexpr char WIFI_PASSWORD[] = "21cc751f57a1";

// See https://thingsboard.io/docs/getting-started-guides/helloworld/
// to understand how to obtain an access token
constexpr char TOKEN[] = "UYunvWwHMS7cYX2o9rai";

// Thingsboard we want to establish a connection too
constexpr char THINGSBOARD_SERVER[] = "http://localhost:8080";
...
void loop() {
  ...
  HTTPClient http;
  http.begin(THINGSBOARD_SERVER + "/api/v1/UYunvWwHMS7cYX2o9rai/telemetry"); //HTTP
  http.addHeader("Content-Type", "application/json");
  String body = String("{temperature:") + String(random(10,40)) + String("}");
